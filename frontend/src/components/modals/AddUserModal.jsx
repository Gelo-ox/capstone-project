                        ...
                        <div className='flex justify-between gap-5'>
                            <div className='flex-1'>
                                <div className='flex flex-col gap-1 mb-3'>
                                    ...
                                    <input onChange={(e) => setFirstName(e.target.value)} id='firstName' type="text" className='flex-1 border-1 border-black outline-none rounded-sm px-3 py-2 text-sm'/>
                                </div>
                                <div className='flex flex-col gap-1 mb-3'>
                                    <label htmlFor="lastName"className='text-sm text-[#797979]'>Last Name</label>
                                    <input onChange={(e) => setLastName(e.target.value)} id='lastName' type="text" className='flex-1 border-1 border-black outline-none rounded-sm px-3 py-2 text-sm'/>
                                </div>
                                <div className='flex flex-col gap-1 mb-3'>
                                    <label htmlFor="email"className='text-sm text-[#797979]'>Email</label>
                                    <input onChange={(e) => setEmail(e.target.value)} id='email' type="email" className='flex-1 border-1 border-black outline-none rounded-sm px-3 py-2 text-sm'/>
                                </div>
                                <div className='flex flex-col gap-1 mb-3'>
